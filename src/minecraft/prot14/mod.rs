...
pub fn generate_block_to_state_map(registry: &Registry) -> HashMap<u16, usize> {
    ...
    let list: &[(u8, u8, &str, Vec<(&str, &str)>)] = &[
        ...
        (33, 0, "minecraft:piston", vec![("facing", "down")]),
        (33, 1, "minecraft:piston", vec![("facing", "up")]),
        (33, 2, "minecraft:piston", vec![("facing", "west")]),
        (33, 3, "minecraft:piston", vec![("facing", "east")]),
        (33, 4, "minecraft:piston", vec![("facing", "north")]),
        (33, 5, "minecraft:piston", vec![("facing", "south")]),
        ...
        (75, 1, "minecraft:redstone_torch_off", vec![("meta", "0")]),
        (75, 2, "minecraft:redstone_torch_off", vec![("meta", "1")]),
        (75, 3, "minecraft:redstone_torch_off", vec![("meta", "2")]),
        (75, 4, "minecraft:redstone_torch_off", vec![("meta", "3")]),
        (75, 5, "minecraft:redstone_torch_off", vec![("meta", "4")]),
        (76, 1, "minecraft:redstone_torch_on", vec![("meta", "0")]),
        (76, 2, "minecraft:redstone_torch_on", vec![("meta", "1")]),
        (76, 3, "minecraft:redstone_torch_on", vec![("meta", "2")]),
        (76, 4, "minecraft:redstone_torch_on", vec![("meta", "3")]),
        (76, 5, "minecraft:redstone_torch_on", vec![("meta", "4")]),
        ...
        (92, 0, "minecraft:cake", vec![("slices", "0")]),
        (92, 1, "minecraft:cake", vec![("slices", "1")]),
        (92, 2, "minecraft:cake", vec![("slices", "2")]),
        (92, 3, "minecraft:cake", vec![("slices", "3")]),
        (92, 4, "minecraft:cake", vec![("slices", "4")]),
        (92, 5, "minecraft:cake", vec![("slices", "5")]),
        (93, 0, "minecraft:repeater_off", vec![]),
        (94, 0, "minecraft:repeater_on", vec![]),
        (95, 0, "minecraft:locked_chest", vec![]),
        (96, 0, "minecraft:trapdoor", vec![("facing", "north"), ("powered", "false")]),
        (96, 1, "minecraft:trapdoor", vec![("facing", "south"), ("powered", "false")]),
        (96, 2, "minecraft:trapdoor", vec![("facing", "east"), ("powered", "false")]),
        (96, 3, "minecraft:trapdoor", vec![("facing", "west"), ("powered", "false")]),
        (96, 4, "minecraft:trapdoor", vec![("facing", "north"), ("powered", "true")]),
        (96, 5, "minecraft:trapdoor", vec![("facing", "south"), ("powered", "true")]),
        (96, 6, "minecraft:trapdoor", vec![("facing", "east"), ("powered", "true")]),
        (96, 7, "minecraft:trapdoor", vec![("facing", "west"), ("powered", "true")]),
    ];
